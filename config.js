...
module.exports = {
    VERSION: 'v3.0.0',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/IpPoINL.jpeg {sender}, I'm alive \n Uptime: {uptime}",
    ...
    SESSION: process.env.SESSION.trim() || 'Raganork~2466b8f2867e1f05ab3c30171c6adc5e:414245476e3850536f77773d',
    ...
    HEROKU: {
        ...
        API_KEY: process.env.HEROKU_API_KEY || 'Menu',
        APP_NAME: process.env.HEROKU_APP_NAME || 'Menu'
    },
